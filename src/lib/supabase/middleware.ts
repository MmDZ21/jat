...
export async function updateSession(request: NextRequest) {
  ...
  // No user trying to access onboarding -> redirect to login
  ...
  if (user && (isDashboardRoute || isOnboardingRoute)) {
    try {
      ...
      // User hasn't completed onboarding and trying to access dashboard -> redirect to onboarding
      ...
      // User has completed onboarding and trying to access onboarding -> redirect to dashboard
